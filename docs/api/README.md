**pebbledash API Reference v0.0.0**
...
- **`@pebbledash/react`** - React bindings *(placeholder)*
- **`@pebbledash/web-component`** - Web Component wrapper *(placeholder)*
- **`@pebbledash/devtools`** - Development/debugging tools *(planned)*
...
- [`@pebbledash/core`](_media/README.md) - Core API and concepts
- [`@pebbledash/renderer-dom`](_media/README-1.md) - DOM rendering and interactions

## Additional Documentation

- [Architecture Overview](_media/architecture.md)
- [Widget Development Guide](_media/widget-development-guide.md)
- [Troubleshooting](_media/troubleshooting.md)
...
│   ├── react/          # React bindings (placeholder)
│   ├── web-component/  # Web Component (placeholder)
